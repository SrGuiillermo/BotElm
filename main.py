...
all_commands = [console_msg_status, word_list_status, vanish_com_status, win_com_status, slot_mach_status, \
                copy_com_status, feiipito_com_status]
